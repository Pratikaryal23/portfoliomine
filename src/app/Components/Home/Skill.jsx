...
const skills = [
  {
    ...
    title: "UI/UX Design",
    description:
      "Creating user-friendly interfaces with a focus on design and usability.",
  ...
  },
  {
    ...
    description:
      "Building responsive, scalable websites using modern web technologies.",
    bgColor: "bg-blue-100",
  ...
  return (
    <div className="w-10/12 mx-auto">
      <h2 className="text-3xl font-bold text-center mb-8">
        {" "}
        My
        <span className="text-red-400 border-b-2 border-black py-1">
          Skills
        </span>{" "}
      </h2>
